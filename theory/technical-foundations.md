...
**See also:** the full [Library](/library/) ledger with PDF links.
...
- **The Holding Equation: A Second-Law–Consistent Gauge for Open-System Viability**  
  ...
  [Page](/notes/canonical/holding-equation/) · [PDF](/assets/pdfs/The_Holding_Equation__A_Second_Law_Consistent_Gauge_for_Open_System_Viability.pdf)

  Introduces the viability gauge  
  \[
  H = \kappa\,\frac{\Phi_S - \sigma}{R(1 + \hat\rho)}
  \]
  linking free-energy surplus, entropy production, relaxation and congestion into a single open-system holding index.  
  

- **ΜΕΡΡ and MEPP-consistent Channels**  

  [Page](/notes/canonical/mepp/) · [PDF](/assets/pdfs/MEPP.pdf)
...
- **The Kernel Stability Principle (KSP)**  
  ...
  [Page](/notes/canonical/ksp/) · [PDF](/assets/pdfs/The_Kernel_Stability_Principle.pdf)
...
- **From Variability to Holding: Canonical Synkyrian Indices and a Unified View of HE · KSP · MEPP**  
  ...
  [Page](/notes/canonical/variability-to-holding/) · [PDF](/assets/pdfs/From_Variability_to_Holding__Canonical_Synkyrian_Indices_and_a_Unified_View_of_HE___KSP___MEPP.pdf)
...
- **Holding as a Viability Functional V – Synkyrian Surrogates and a Representation Theorem**  
  ...
  [Page](/notes/hvf-v/) · [PDF](/assets/pdfs/Holding_as_a_Viability_Functional_V.pdf)

  Studies surrogate holding indices \(H_{\mathrm{syn}}\) and proves that, under a conservative viability bound and a calibration axiom against failure probabilities, \(H_{\mathrm{syn}}\) must be a monotone transform of the rigorous log-hazard functional \(H_{\mathrm{rig}}\).  
  

- **Holding as a Viability Functional – Environmental Left Tails and Long-Time Survival of Open Systems**  

  [Page](/notes/hvf-open/) · [PDF](/assets/pdfs/Holding_as_a_Viability_Functional.pdf)

  Treats holding as a functional of the **left tail** of environmental decay rates and classifies long-time survival in terms of the behaviour of that distribution near zero.  
  

- **Holding as a Viability Functional X – A Variational Principle for Flow under Viability Constraints**  

  [Page](/notes/hvf-x/) · [PDF](/assets/pdfs/X__A_Variational_Principle_for_Flow_under_Viability_Constraints.pdf)

  Formulates a variational problem for flows (and entropy production) subject to a hard holding constraint \(H_{\mathrm{rig}} \ge H_{\min}\). Shows that optimal operation sits on the critical surface \(H = H_{\min}\).  
...
- **XI – Cheeger-type Bounds for Synkyrian Network Holding**  
  ...
  [Page](/notes/hvf-xi/) · [PDF](/assets/pdfs/XI__Cheeger_type_Bounds_for_Synkyrian_Network_Holding.pdf)
...
- **Network Composition, Coupling and Kernel Stability**  
  ...
  [Page](/notes/hvf-vii/) · [PDF](/assets/pdfs/holding_vii_network_composition_ksp.pdf)
...
- **P0 — Synkyrian Stability (canonical spine)** — [Page](/papers/stability/) · [PDF](/assets/pdfs/Synkyrian_Stability_as_an_Architectural_Framework.pdf)
- **P1 — Tropic Information Theory** — [Page](/papers/tropic-information-theory/) · [PDF](/assets/pdfs/Tropic_Information_Theory.pdf)
- **P2 — Synkyrian Geometric Morphogenesis** — [Page](/papers/geometric-morphogenesis/) · [PDF](/assets/pdfs/Synkyrian_Geometric_Morphogenesis.pdf)
- **P3 — Thermodynamic Right to Refusal** — [Page](/papers/right-to-refusal/) · [PDF](/assets/pdfs/The_Thermodynamic_Right_to_Refusal.pdf)
- **P4 — Invariant-Preserving Morphogenetic Filtering** — [Page](/papers/invariant-morphogenetic-filtering/) · [PDF](/assets/pdfs/Invariant_Preserving_Morphogenetic_Filtering.pdf)
- **P5 — Synkyrian Networked Fields** — [Page](/papers/networked-fields/) · [PDF](/assets/pdfs/synkyrian_networked_fields.pdf)
- **P6 — Synkyrian Network Policies** — [Page](/papers/network-policies/) · [PDF](/assets/pdfs/synkyrian_network_policies.pdf)
